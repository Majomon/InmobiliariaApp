...
function DetailInfoTop({ dataAxios,theme }) {
  return (
    <div className="w-full h-full ">
      ...
      <div className="w-full h-full flex justify-center items-center bg-white shadow-md px-16">
        <div className="w-7/12 h-[7rem] flex py-4">
          <div className="w-6/12 h-full">
            <h3 className="text-base font-bold">{dataAxios.name}</h3>
            <h4>
          ...
          <div className="w-6/12 h-full">
            {dataAxios.operation === "Alquiler" ? (
              <div>
                ...
                <h3 className="text-base font-bold">${dataAxios.price}</h3>
                <p className="text-gray-400">Por mes</p>
              </div>
            ) : (
              <div>
                <p className="text-gray-400">PRECIO VENTA</p>
                <h3 className="text-base font-bold">U$S{dataAxios.price}</h3>
              </div>
            )}
          </div>
        </div>
