...
function PropertyCard(properties) {
  ...
  return (
    <Link to={`/detail/${_id}`}>
      <div className="w-[380px] mx-auto my-8 rounded-md shadow-xl hover:shadow-2xl border border-gray-300 dark:shadow-white dark:shadow-xl">
        ...
        <div className="w-full flex flex-col justify-between items-center py-2 px-4">
          <h2 className="font-bold text-base py-2 dark:text-gray-100 ">{name}</h2>
        ...
        <div className="w-full grid grid-cols-3 bg-gray-300 p-2">
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="text-base text-gray-600 dark:text-gray-700">{area} m²</p>
          </div>
          <div className="flex flex-col justify-center items-center">
